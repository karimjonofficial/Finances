...
class RemoteLoginDataSource private constructor(private val apiService: CredentialsApiService) : CredentialsDataSource {
    ...
    companion object {
        fun create(retrofit: Retrofit): CredentialsDataSource {
            return RemoteLoginDataSource(retrofit.create<CredentialsApiService>())
        }
    }
}
